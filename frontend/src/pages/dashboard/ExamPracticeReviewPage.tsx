  ...
  return (
    <section className="space-y-8">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <p className="text-sm uppercase tracking-[0.3em] text-slate-500">Pembahasan Ujian</p>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button onClick={() => navigate('/app/ujian/soal')}>
            Pilih Ujian Lain
          </Button>
        </div>
      </div>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            ...
            >
              {data.score >= 70 ? 'Baik' : 'Perlu Ujian Lagi'}
            </Badge>
