  ...
  return (
    <section className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="text-xs uppercase tracking-[0.3em] text-slate-400">Paket Ujian Soal</p>
        ...
        <Button
          variant="outline"
          onClick={() => navigate(`/app/ujian/soal/kategori/${category.slug}/sub/${subCategory.id}`)}
        >
          Kembali
        </Button>
      </div>
              ...
              <Card key={set.id} className="overflow-hidden">
                <CardContent className="p-0">
                  ...
                  <div className="space-y-2 p-4">
                    ...
                    <Button className="w-full" onClick={() => navigate(`/app/ujian/soal/detail/${set.slug}`)}>
                      Lihat Detail
                    </Button>
                  </div>
                </CardContent>
